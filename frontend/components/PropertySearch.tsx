...
export default function PropertySearch() {
  ...
  const onSubmit = (data: SearchForm) => {
    ...
    if (data.propertyType && data.propertyType !== 'Any') params.set('property_type', data.propertyType)
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mb-8 rounded-lg bg-white p-6 shadow">
